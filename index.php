...
<head>
    ...
    <link rel="website icon" href="/assets/images/GroceryMart_Logo.webp" />
...
<body>
    ...
    <header>
        <a href="index.php" class="logo">
            <img src="/assets/images/GroceryMart_Logo.webp" class="img-fluid rounded">
            GroceryMart
        </a>
        ...
        <ul class="nav-list" id="nav-list">
            ...
            <li><a href="/index.php#products" class="text-capitalize">products</a></li>
    ...
    <section class="pages" id="pages">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-sm-6 col-md-4 my-5 text-center">
                    <img src="/assets/images/prince.webp" class="img-fluid rounded" alt="">
                </div>
                <div class="col-12 col-sm-6 col-md-4 my-5 text-center">
                    <img src="/assets/images/beltexco.webp" class="img-fluid rounded" alt="">
                </div>
                <div class="col-12 col-sm-6 col-md-4 my-5 text-center">
                    <img src="/assets/images/swissta.webp" class="img-fluid rounded" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="newsletter" id="newsletter">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-white text-md-left">
